//
//  MultiCellHistoryView.swift
//  P2PCount
//
//  Created by Dany on 15.05.2025.
//

import UIKit

protocol MultiCellHistoryViewProtocol: AnyObject {
    func setData(data: HistoryItem)
}

class MultiCellHistoryView: UICollectionViewCell, MultiCellHistoryViewProtocol{
    
    static let reuseIdentifier: String = "MultiCellHistoryView"
    ...
    lazy var buyNameExchange = createTextLabel(text: "", font: UIFont(name: "K2D-Light", size: 11), alignment: .center)
    lazy var buyNameCurrencyPair = createTextLabel(text: "", font: UIFont(name: "K2D-Light", size: 11), alignment: .center)
    ...
    lazy var sellNameExchange = createTextLabel(text: "", font: UIFont(name: "K2D-Light", size: 11), alignment: .center)
    lazy var sellNameCurrencyPair = createTextLabel(text: "", font: UIFont(name: "K2D-Light", size: 11), alignment: .center)
